...
export default class Story extends Component {
  render(): string {
    return `
      <section id="story" class="flex flex-col items-center py-32 gap-6">
          <h2 class="text-white text-2xl font-semibold"> Histoire </h2>
          <div class="flex gap-24 items-center p-4 w-[50%]">
